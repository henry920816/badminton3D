...
- `badminton3D-main/badminton3D-main/` 重複資料夾

這些不影響核心功能，但之後整理 repo 時建議清理，避免結構混亂。

### 13.4 README 與實作可能有版本落差

目前原 README 的描述比實作略樂觀一些。  
接手或報告時，建議以實際程式碼為準。
...
### 14.1 多視角影片支援
目前資料結構已有 camera 概念，但前端還沒有完整多視角工作流。

### 14.2 更完整的 anomaly 產生流程
現在 anomaly 可以顯示與更新，但產生與匯入邏輯仍可再完整化。
...
> **把羽球 3D 軌跡、擊球標註、時間軸、影片與資料修復，整合成同一個可互動的校正平台。**
